    ...
    <>
      <div className={'body-menu'} onClick={CloseModal}>
        <div className={`container ${blur==true ? 'active' : ''}`} id="blur" >
          <NavMenuLeft setSearch={search} category={SetCategory} setOpen={SetOpen} SetNewCategory={SetNewCategory}/>
        ...
        <ModalNewCategory  SetNewCategory={SetNewCategory} NewCategory={NewCategory} />
